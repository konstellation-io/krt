...
var ErrInvalidProcessMemory = errors.New("invalid process memory, must be of form '350M'") // queremos tambien las medidas para frikis? https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#meaning-of-memory
